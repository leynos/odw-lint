...
This rule reports when a workflow source file has no real `export const meta =`
declaration. ODW needs that metadata envelope before it can identify and run
the workflow.
