...
const odwExampleFixture = (
  fixture: Omit<OdwExampleFixtureSnapshot, "expectedStatus" | "expectedDiagnostics">,
...
export const ODW_EXAMPLE_FIXTURE_SNAPSHOTS = Object.freeze([
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/adversarial-verify.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/adversarial-verify.js`,
  ...
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/agent-daily-digest.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/agent-daily-digest.js`,
  ...
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/codex-claude-loop.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/codex-claude-loop.js`,
  ...
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/deep-research.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/deep-research.js`,
    metaName: "deep-research",
    sha256: "c703b2d7708e66136b38556171be799eca121a241343819a6654d1eae865ff84",
  }),
  odwExampleFixture({
    fileName: "fan-out-reduce.js",
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/fan-out-reduce.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/fan-out-reduce.js`,
  ...
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/generate-and-filter.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/generate-and-filter.js`,
  ...
  odwExampleFixture({
    ...
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/loop-until-dry.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/loop-until-dry.js`,
    metaName: "loop-until-dry",
    sha256: "8e856df8d09521ed1810e41e7873ca583a7472b15e0067bacff80dd94a269238",
  }),
  odwExampleFixture({
    fileName: "routing.js",
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/routing.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/routing.js`,
    metaName: "routing",
    sha256: "0d595872da03aa7e1bfd91bb8da84ba5b1605d4f82f8b522e492d17343645f3c",
  }),
  odwExampleFixture({
    fileName: "tournament.js",
    fixturePath: `${ODW_EXAMPLES_FIXTURE_ROOT}/tournament.js`,
    upstreamPath: `${UPSTREAM_ODW_EXAMPLES_ROOT}/tournament.js`,
    metaName: "tournament",
