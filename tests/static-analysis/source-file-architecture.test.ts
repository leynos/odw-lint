...
describe("source-file helper architecture", () => {
  ...
  it("keeps inert-region masking in source-mask", () => {
    ...
    expectModuleDeclarations("src/static-analysis/source-mask-templates.ts", [
      "isTemplateRegexStart",
      "nextEscapedTemplateIndex",
      "nextTemplateExpressionInertRegionEnd",
      "nextTemplateIndex",
      "previousSignificantTemplateIndex",
      "previousSignificantTemplateToken",
      "previousTemplateCommentStartIndex",
      "previousTemplateLineStartIndex",
      "scanTemplateExpressionEnd",
