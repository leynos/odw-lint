...
const EXPECTED_RULE_ROWS = [
  ["odw/meta-required", "dialect", "error", "meta-required", "released"],
  ["odw/meta-object", "dialect", "error", "meta-object", "released"],
  [
  ...
  ["odw/meta-name", "dialect", "error", "meta-name", "released"],
  ["odw/meta-description", "dialect", "error", "meta-description", "released"],
  ["odw/no-import-export", "dialect", "error", "no-import-export", "released"],
  ["odw/body-syntax", "dialect", "error", "body-syntax", "released"],
  ...
  ["odw/no-argless-new-date", "claude-compatibility", "warning", "no-argless-new-date", "released"],
  ["odw/no-odw-only-validate", "claude-compatibility", "info", "no-odw-only-validate", "released"],
...
const expectedRuleRows = (): string[][] => {
  return EXPECTED_RULE_ROWS.map((row) => [...row]);
};
